...
func (oc *Controller) addPod(key string) error {

	namespace, name, err := cache.SplitMetaNamespaceKey(key)
	if err != nil {
		return err
	}
	pod, err := oc.podsLister.Pods(namespace).Get(name)
	if err != nil {
		return err
	}
...
func (oc *Controller) updatePod(key string) error {
